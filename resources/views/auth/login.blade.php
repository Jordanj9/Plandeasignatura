                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
                            <form id="sign_in" class="form-horizontal" method="POST" action="{{route('login')}}">
                                ...
                                <div class="card card-login card-hidden">
                                    ...
                                    <div class="card-body ">
                                        <p class="card-description text-center">PS - PlanSotf</p>
                                        <span class="bmd-form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required="required" placeholder="Identificacion" name="identificacion">
                                            </div>
                                        </span>
                                        <span class="bmd-form-group">
                                            <div class="input-group">
                                    ...
                                    <div class="card-footer justify-content-center">
                                        <button type="submit" class="btn btn-success btn-link btn-lg">Ingresar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
