            ...
            <div class="col-md-12">
                <p class="animated fadeInDown">
                    <a href="{{route('inicio')}}">Inicio </a><span class="fa-angle-right fa"></span><a
                        ...
                        class="fa-angle-right fa"></span><a href="{{route('asignatura.index')}}">
                        Asignaturas </a><span
            ...
            <div class="card">
                <div class="card-header card-header-success card-header-text">
                    <div class="card-text col-md-6">
                        <h4 class="card-title">EDITAR DATOS DE LA ASIGNATURA
                            : {{$asignatura->codigo."-".$asignatura->nombre}}</h4>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" method="POST"
                              action="{{route('asignatura.update',$asignatura->id)}}">
                            @csrf
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <select class="selectpicker"
                                                        ...
                                                        name="naturaleza">
                                                    @if($asignatura->naturaleza =='TEORICO')
                                                        <option value="TEORICO" selected>TEÓRICO</option>
                                                        <option value="PRACTICO">PRÁCTICO</option>
                                                        <option value="TEORICO-PRACTICO">TEÓRICO-PRÁCTICO</option>
                                                    @elseif($asignatura->naturaleza == 'PRACTICO')
                                                    ...
                                                    @else
                                                        <option value="TEORICO">TEÓRICO</option>
                                                        <option value="PRACTICO">PRÁCTICO</option>
                                                        <option value="TEORICO-PRACTICO" selected>TEÓRICO-PRÁCTICO
                                                        </option>
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="number" class="form-control" min="0"
                                                       ...
                                                       name="hora_practica" value="{{$asignatura->hora_practica}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="number" class="form-control" min="0"
                                                       ...
                                                       name="hora_teorica" value="{{$asignatura->hora_teorica}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <br/><br/><a href="{{route('asignatura.index')}}"
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong> Edite las asignaturas pertenecientes a un programa.
                </div>
