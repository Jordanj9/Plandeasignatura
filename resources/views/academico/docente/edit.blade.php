            ...
            <div class="col-md-12">
                <p class="animated fadeInDown">
                    <a href="{{route('inicio')}}">Inicio </a><span class="fa-angle-right fa"></span><a
                        ...
                        class="fa-angle-right fa"></span><a href="{{route('programa.index')}}">
                        Programas </a><span
            ...
            <div class="card">
                <div class="card-header card-header-success card-header-text">
                    <div class="card-text col-md-6">
                        <h4 class="card-title">EDITAR DATOS DEL PROGRAMA : {{$programa->nombre}}</h4>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" method="POST"
                              action="{{route('programa.update',$programa->id)}}">
                            @csrf
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       name="nombre" required="required" value="{{$programa->nombre}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       name="descripcion" value="{{$programa->descripcion}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="form-line">
                                                ...
                                                <select class="form-control selectpicker"
                                                    ...
                                                    @foreach($deptos as $key=>$value)
                                                        @if($key==$programa->departamento->id)
                            ...
                            <div class="form-group">
                                <br/><br/><a href="{{route('programa.index')}}"
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong> Edite las Facultades, recuerde que el campo nombre es requerido.
                </div>
