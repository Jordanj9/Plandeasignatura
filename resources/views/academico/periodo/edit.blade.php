            ...
            <div class="card">
                <div class="card-header card-header-success card-header-text">
                    <div class="card-text col-md-6">
                        <h4 class="card-title">EDITAR DATOS DEl PERÍODO : {{$periodo->periodo}}</h4>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" method="POST" action="{{route('periodo.update',$periodo->id)}}">
                            @csrf
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="number" class="form-control"
                                                       ...
                                                       name="anio" max="3000" min="2000" required="required" value="{{$periodo->anio}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="number" class="form-control"
                                                       ...
                                                       name="periodo" max="2" min="1" required="required" value="{{$periodo->periodo}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control"
                                                       placeholder="Escriba el período"
                                                       name="fechainicio" required="required" value="{{$periodo->fechainicio}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control"
                                                       placeholder="Escriba el período"
                                                       name="fechafin" required="required" value="{{$periodo->fechafin}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" name="fechainicio1"
                                                       required="required" value="{{$periodo->fechainicio1}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control"
                                                       placeholder="Escriba el período"
                                                       name="fechafin1" required="required" value="{{$periodo->fechafin1}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" name="fechainicio2"
                                                       required="required"value="{{$periodo->fechainicio2}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" name="fechafin2"
                                                       required="required" value="{{$periodo->fechafin2}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" name="fechainicio3"
                                                       required="required" value="{{$periodo->fechainicio3}}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="date" class="form-control" name="fechafin3"
                                                       required="required" value="{{$periodo->fechafin3}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong> Edite las Períodos, recuerde que todos los campos son requeridos.
                </div>
