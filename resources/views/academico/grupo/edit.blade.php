            ...
            <div class="card">
                <div class="card-header card-header-success card-header-text">
                    <div class="card-text col-md-6">
                        <h4 class="card-title">EDITAR DATOS DEL GRUPO : {{$grupo->nombre}}</h4>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" method="POST" action="{{route('grupo.update',$grupo->id)}}">
                            @csrf
                                        ...
                                        <div class="form-group bmd-form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" class="form-control"
                                                       ...
                                                       name="nombre" required="required" value="{{$grupo->nombre}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <br/><br/><a href="{{route('grupo.index')}}"
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong> Edite los Grupos, recuerde que el campo nombre es requerido.
                </div>
