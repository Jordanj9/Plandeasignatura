                        ...
                        <ul class="navbar-nav pull-right">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    <a href="{{ route('extension_create',$plan) }}" class="dropdown-item" href="#">Agregar
                                        Actividad de extensión y proyección social</a>
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong>Gestione cada una de las actividades de extensión y proyección social que desee agregar al plan de trabajo.
                </div>
