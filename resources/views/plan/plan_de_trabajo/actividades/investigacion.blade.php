                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                                    <a href="{{ route('plandetrabajo.create') }}" class="dropdown-item" href="#">Agregar
                                        Actividad de investigación aprobada</a>
                ...
                <div class="card-body">
                    <div class="material-datatables">
                        <table>
                            ...
                            <tr>
                                <td>TITULO DE CADA TRABJO DEINVESTIGACIÓN</td>
                                <td>Acta</td>
                                <td>Fecha</td>
                                <td>Iniciación</td>
                                <td>Terminación</td>
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Detalles: </strong>Gestione cada una de las actividades de investigación aprobada que desee agregar al plan de trabajo.
                </div>
