        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Agregue nuevos datos de otras actividades,</strong> Ingrese cada uno de las despcripciones que conforman
                    el cuadro explicativo de otras actividades refrente al plan de trabajo que esta realizando.
                </div>
