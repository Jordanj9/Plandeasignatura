            ...
            <div class="card">
                <div class="card-header card-header-success card-header-text">
                    <div class="card-text col-md-6">
                        <h4 class="card-title">DATOS DE INVESTIGACION APROBADA</h4>
                    </div>
                        ...
                        <form class="form-horizontal" method="POST" action="{{route('guardar_trabajo')}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <label for="">TITULO DE CADA TRABAJO DE INVESTIGACIÓN</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <label for="">Iniciacion</label>
                                            <br/><input type="date" class="form-control"
                                                        placeholder=""
                                                        name="iniciacion" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <label for="Terminación">Terminación</label>
                                            <br/><input type="date" class="form-control"
                                                        placeholder=""
                                                        name="terminacion" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
        ...
        <div class="modal-dialog modal-small">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <strong>Agregue nuevos datos de investigación aprobada,</strong> Ingrese cada uno de las despcripciones que conforman
                    el cuadro explicativo de investigación aprobada refrente al plan de trabajo que esta realizando.
                </div>
